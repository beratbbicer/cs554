...
srresnet_checkpoint = "checkpoint_srresnet_e5_96r2.pth.tar"#"checkpoint_srresnet.pth.tar"  # filepath of the trained SRResNet checkpoint used for initialization
...
# Learning parameters
checkpoint = '26checkpoint_srgan.pth.tar'  # path to model (SRGAN) checkpoint, None if none
...
print_freq = 300  # print training status once every __ batches
...
def main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        torch.save({'epoch': epoch,
                    ...
                    'optimizer_g': optimizer_g,
                    'optimizer_d': optimizer_d},
                   str(epoch) + 'checkpoint_srgan.pth.tar')
