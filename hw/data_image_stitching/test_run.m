...
matches = [matching_idx1; matching_idx2];
numMatches = size(matches,2);
X1 = f1(1:2, matching_idx1); X2 = f2(1:2, matching_idx2);
% [X1, X2] = clean_matches(X1, X2);
X1(3,:) = 1 ; X2(3,:) = 1 ;
